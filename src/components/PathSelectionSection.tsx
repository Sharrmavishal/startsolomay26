...
const WomenIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 8C27.3137 8 30 10.6863 30 14C30 17.3137 27.3137 20 24 20C20.6863 20 18 17.3137 18 14C18 10.6863 20.6863 8 24 8Z" fill="#5FA6A0"/>
    <path d="M24 22C27.3137 22 30 24.6863 30 28V36H27V42H21V36H18V28C18 24.6863 20.6863 22 24 22Z" fill="#5FA6A0"/>
    <circle cx="36" cy="14" r="4" fill="#EEB44E"/>
    <circle cx="12" cy="14" r="4" fill="#EEB44E"/>
  </svg>
);

const GraduatesIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 6L42 16L24 26L6 16L24 6Z" fill="#5FA6A0"/>
    <path d="M14 20V30C14 33.3137 18.4772 36 24 36C29.5228 36 34 33.3137 34 30V20" stroke="#1D3A6B" strokeWidth="2"/>
    <path d="M42 16V28" stroke="#1D3A6B" strokeWidth="2"/>
    <path d="M42 32C43.1046 32 44 31.1046 44 30C44 28.8954 43.1046 28 42 28C40.8954 28 40 28.8954 40 30C40 31.1046 40.8954 32 42 32Z" fill="#EEB44E"/>
  </svg>
);

const EngineersIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 10C26.2091 10 28 11.7909 28 14C28 16.2091 26.2091 18 24 18C21.7909 18 20 16.2091 20 14C20 11.7909 21.7909 10 24 10Z" fill="#5FA6A0"/>
    <path d="M36 26L30 20H18L12 26L18 32H30L36 26Z" fill="#EEB44E"/>
    <path d="M18 32V38H30V32" stroke="#1D3A6B" strokeWidth="2"/>
    <path d="M24 18V20" stroke="#1D3A6B" strokeWidth="2"/>
  </svg>
);
...
const pathOptions = [
  {
    ...
    hoverColorClass: "group-hover:text-navy",
    iconColor: "#5FA6A0",
    ...
    <section className="py-12 md:py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-4">Choose Your Path</h2>
